...
class AppStyle {
  static TextStyle txtPoppinsRegular12Blue700a9 = TextStyle(
    color: ColorConstant.blue700A9,
  ...
  static TextStyle txtPoppinsMedium14RedA200b7 = TextStyle(
    color: ColorConstant.redA200B7,
    fontSize: getFontSize(
      14,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsBold29Bluegray800 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular12LightgreenA700a9 = TextStyle(
    color: ColorConstant.lightGreenA700A9,
    fontSize: getFontSize(
      12,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsRegular12Bluegray800 = TextStyle(
    color: ColorConstant.bluegray800,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsMedium14Bluegray8008f = TextStyle(
  ...
  static TextStyle txtPoppinsMedium14LightgreenA700a9 = TextStyle(
    color: ColorConstant.lightGreenA700A9,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPoppinsRegular16Bluegray800a9 = TextStyle(
  ...
  static TextStyle txtPoppinsSemiBold20Yellow900 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular12RedA200 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular14Yellow900 = TextStyle(
    color: ColorConstant.yellow900,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPoppinsMedium16LightgreenA700 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium15Gray700 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium16Gray800 = TextStyle(
    color: ColorConstant.gray800,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsMedium29 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      29,
    ),
  ...
  static TextStyle txtPoppinsBold29LightgreenA700 = TextStyle(
    color: ColorConstant.lightGreenA700,
    fontSize: getFontSize(
      29,
    ),
  ...
  static TextStyle txtPoppinsRegular14Bluegray800b7 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium16Yellow900 = TextStyle(
    color: ColorConstant.yellow900,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsRegular16Bluegray800 = TextStyle(
    color: ColorConstant.bluegray800,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtMontserratRegular813 = TextStyle(
  ...
  static TextStyle txtPoppinsBold29 = TextStyle(
    color: ColorConstant.gray800,
    fontSize: getFontSize(
      29,
    ),
  ...
  static TextStyle txtPoppinsMedium16RedA200 = TextStyle(
    color: ColorConstant.redA200,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsMedium20Bluegray800 = TextStyle(
    color: ColorConstant.bluegray800,
    fontSize: getFontSize(
      20,
    ),
  ...
  static TextStyle txtPoppinsMedium14LightgreenA700 = TextStyle(
    color: ColorConstant.lightGreenA700,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPoppinsRegular12Bluegray800b7 = TextStyle(
    color: ColorConstant.bluegray800B7,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsRegular16Bluegray8008f = TextStyle(
    color: ColorConstant.bluegray8008f,
    fontSize: getFontSize(
      16,
    ),
